...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.post(baseUrl + "/httpsvideochat9/ea/sjp/codecom", authorize(["ADMIN"]), UserController.VideochatappNohackingallowedmaster1);
  ...
  */
  ...
  /**
  * UserModel.VideochatappNohackingallowedmaster1
  *   @description Change password of user from admin
  *   @returns object
  *
  */
  VideochatappNohackingallowedmaster1: async (req, res) => {
    try {
      res.json({});
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
