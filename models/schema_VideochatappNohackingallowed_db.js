...
import Database from "../classes/Database_VideochatappNohackingallowed_db";
  ...
  let sequelize = Database.getConnection();
    ...
    User.init({
      ...
      VideoChat: {
          type: Sequelize.INTEGER,
        references: {
            model: VideoChatApp_Pleasedonothack,
          key: '_id',
        }
      },
      */
    ...
    /**
      ...
      * ------------------------------------
      */
    class VideoChatApp_Pleasedonothack extends Sequelize.Model{}
    VideoChatApp_Pleasedonothack.init({
        _id: { 
          type: Sequelize.INTEGER,
        primaryKey: true,
        autoIncrement: true
      ...
      */
      ...
      { sequelize, tableName: "videochatapp_pleasedonothack", timestamps: false }
    );
    ...
    VideoChatApp_Pleasedonothack.belongsToMany(User, {
          through: "VideoChatApp_Pleasedonothack_VideoChat",
        as: "VideoChat",
        foreignKey: "id_VideoChatApp_Pleasedonothack",
        otherKey: "id_User",
        timestamps: false
    });
