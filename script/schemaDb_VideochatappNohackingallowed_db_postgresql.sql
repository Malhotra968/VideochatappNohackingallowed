...
CREATE DATABASE videochatappnohackingallowed_db;
...
--
-- Schema entity videochatapp_pleasedonothack
--
...
CREATE TABLE IF NOT EXISTS "VideoChatApp_Pleasedonothack_VideoChat" (
    "_id" SERIAL PRIMARY KEY,
    "id_VideoChatApp_Pleasedonothack" INTEGER  NOT NULL REFERENCES "videochatapp_pleasedonothack"(_id),
